...
_SCRIPT_REGISTERED_CLASS_DECL( FGUIEvent )
_SCRIPT_REGISTERED_CLASS_IMPL_BEGIN_WITHOUT_CD( FGUIEvent, "The GUI events" )
{
	_SCRIPT_REGISTERED_CLASS_REGISTER_ENUM_VALUE( "FocusOn", _FGUI_EVENT_FOCUS_ON, "" )
	_SCRIPT_REGISTERED_CLASS_REGISTER_ENUM_VALUE( "FocusOff", _FGUI_EVENT_FOCUS_OFF, "" )
	_SCRIPT_REGISTERED_CLASS_REGISTER_ENUM_VALUE( "Show", _FGUI_EVENT_SHOW, "" )
	_SCRIPT_REGISTERED_CLASS_REGISTER_ENUM_VALUE( "Hide", _FGUI_EVENT_HIDE, "" )
	_SCRIPT_REGISTERED_CLASS_REGISTER_ENUM_VALUE( "ani_stop", _FGUI_EVENT_ANIMATION_STOPPED, "" )
	_SCRIPT_REGISTERED_CLASS_REGISTER_ENUM_VALUE( "check_on", _FGUI_EVENT_CHECK_ON, "" )
	_SCRIPT_REGISTERED_CLASS_REGISTER_ENUM_VALUE( "check_off", _FGUI_EVENT_CHECK_OFF, "" )
	_SCRIPT_REGISTERED_CLASS_REGISTER_ENUM_VALUE( "Click", _FGUI_EVENT_CLICK, "" )
}
_SCRIPT_REGISTERED_CLASS_IMPL_END( )
...
extern "C" void RegisterZFScript( )
{
...
_SCRIPT_REGISTERED_CLASS_REGISTER( FGUIEvent )
