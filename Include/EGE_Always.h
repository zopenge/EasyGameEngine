...
_void ConvertRectToVertex( Vector2& lt, Vector2& rt, Vector2& rb, Vector2& lb, const RectType& rect )
{
...
template< typename RectType >
_void ConvertRectToVertex( Vector3& lt, Vector3& rt, Vector3& rb, Vector3& lb, const RectType& rect )
{
	// Build vertex position
	lt.x = (_float) rect.l;
	lt.y = (_float) rect.t;
