...
#define EGE_EVENT_1(c, id_value, t1, n1)                \
	EGE_EVENT_BEGIN_BASE(c, id_value, EGE_EVENT_OFFSET) \
	t1 n1;                                              \
	c(t1 param_##n1) : BaseClass(id_value) {            \
		n1 = param_##n1;                                \
	}                                                   \
	EGE_EVENT_CLONE_BEGIN(c)                            \
	event->n1 = n1;                                     \
...
#define EGE_EVENT_2(c, id_value, t1, n1, t2, n2)            \
	...
	t1 n1;                                                  \
	t2 n2;                                                  \
	c(t1 param_##n1, t2 param_##n2) : BaseClass(id_value) { \
		n1 = param_##n1;                                    \
		n2 = param_##n2;                                    \
	}                                                       \
	EGE_EVENT_CLONE_BEGIN(c)                                \
...
#define EGE_EVENT_3(c, id_value, t1, n1, t2, n2, t3, n3)                   \
	...
	t2 n2;                                                                 \
	t3 n3;                                                                 \
	c(t1 param_##n1, t2 param_##n2, t3 param_##n3) : BaseClass(id_value) { \
		n1 = param_##n1;                                                   \
		n2 = param_##n2;                                                   \
		n3 = param_##n3;                                                   \
	}                                                                      \
...
#define EGE_EVENT_4(c, id_value, t1, n1, t2, n2, t3, n3, t4, n4)                          \
	...
	t3 n3;                                                                                \
	t4 n4;                                                                                \
	c(t1 param_##n1, t2 param_##n2, t3 param_##n3, t4 param_##n4) : BaseClass(id_value) { \
		n1 = param_##n1;                                                                  \
		n2 = param_##n2;                                                                  \
		n3 = param_##n3;                                                                  \
		n4 = param_##n4;                                                                  \
...
#define EGE_EVENT_5(c, id_value, t1, n1, t2, n2, t3, n3, t4, n4, t5, n5)                                 \
	...
	t4 n4;                                                                                               \
	t5 n5;                                                                                               \
	c(t1 param_##n1, t2 param_##n2, t3 param_##n3, t4 param_##n4, t5 param_##n5) : BaseClass(id_value) { \
		n1 = param_##n1;                                                                                 \
		n2 = param_##n2;                                                                                 \
		n3 = param_##n3;                                                                                 \
		n4 = param_##n4;                                                                                 \
...
#define EGE_EVENT_6(c, id_value, t1, n1, t2, n2, t3, n3, t4, n4, t5, n5, t6, n6)                                        \
	...
	t5 n5;                                                                                                              \
	t6 n6;                                                                                                              \
	c(t1 param_##n1, t2 param_##n2, t3 param_##n3, t4 param_##n4, t5 param_##n5, t6 param_##n6) : BaseClass(id_value) { \
		n1 = param_##n1;                                                                                                \
		n2 = param_##n2;                                                                                                \
		n3 = param_##n3;                                                                                                \
		n4 = param_##n4;                                                                                                \
...
#define EGE_EVENT_SESSION_BEGIN(x1, x2) \
	EGE_BEGIN_NAMESPACE_2(x1, x2)       \
	DECLARE_COUNTER;
