...
/// <summary>
/// THe FNT format is a by now outdated file format used for storing fonts on computers running with the Windows operating system.
/// It was saved in the system fonts directory.
/// By now, the FNT file has been almost completely replaced by TTF (TrueType Font) and OTF (OpenType Font) files.
/// </summary>
