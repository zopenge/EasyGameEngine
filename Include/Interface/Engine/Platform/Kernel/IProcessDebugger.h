...
public:
	...
	virtual _ubool Run( AStringPtr modulename, AStringPtr cmdline, _dword creationflags, AStringPtr workdir, _ubool nodebugheap = _true, _ubool fastmode = _false ) PURE;
	//!	Run the process.
	//!	@param		modulename		The module name of launching.
	//!	@param		cmdline			The command line of launching.
	//!	@param		creationflags	The creation flags, @see _PROCESS_CREATION.
