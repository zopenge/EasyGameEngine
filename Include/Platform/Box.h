...
class Box {
 ...
 public:
  inline Box();
  inline Box(_float min_x, _float min_y, _float min_z, _float max_x,
             _float max_y, _float max_z);
...
Box::Box(_float min_x, _float min_y, _float min_z, _float max_x, _float max_y,
         _float max_z) {
