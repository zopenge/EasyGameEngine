...
inline _float Interpolation::Current(_float alpha) { return 0.0f; }

inline _float Interpolation::Next(_float alpha) { return 1.0f; }

inline _float Interpolation::Middle(_float alpha) { return 0.5f; }

inline _float Interpolation::Linear(_float alpha) { return alpha; }

inline _float Interpolation::IntegralCurrent() { return 0.0f; }

inline _float Interpolation::IntegralNext() { return 1.0f; }

inline _float Interpolation::IntegralMiddle() { return 0.5f; }

inline _float Interpolation::IntegralLinear() { return 0.5f; }
...
inline _float Interpolation::QuadIn(_float alpha) { return alpha * alpha; }
...
inline _float Interpolation::ElasticOut(_float alpha) {
  ...
  return Math::Pow(2.0f, -10.0f * alpha) *
             Math::Sin((alpha - s) * Math::c2Pi / param1) +
         1.0f;
}
...
inline _float Interpolation::Elastic(_float alpha) {
  if (alpha == 0.0f || alpha == 1.0f) return 0.0f;

  _float param1 = 0.3f;
  return Math::Pow(2.0f, -10.0f * alpha) *
         Math::Sin((alpha)*Math::c2Pi / param1);
}
...
inline _float Interpolation::IntegralSineInOut() { return 0.5f; }

inline _float Interpolation::IntegralSineOutIn() { return 0.5f; }

inline _float Interpolation::IntegralQuadInOut() { return 0.5f; }

inline _float Interpolation::IntegralQuadOutIn() { return 0.5f; }

inline _float Interpolation::IntegralCubicInOut() { return 0.5f; }

inline _float Interpolation::IntegralCubicOutIn() { return 0.5f; }

inline _float Interpolation::IntegralQuartInOut() { return 0.5f; }

inline _float Interpolation::IntegralQuartOutIn() { return 0.5f; }

inline _float Interpolation::IntegralQuintInOut() { return 0.5f; }

inline _float Interpolation::IntegralQuintOutIn() { return 0.5f; }

inline _float Interpolation::IntegralExpoInOut() { return 0.5f; }

inline _float Interpolation::IntegralExpoOutIn() { return 0.5f; }

inline _float Interpolation::IntegralCircInOut() { return 0.5f; }

inline _float Interpolation::IntegralCircOutIn() { return 0.5f; }

inline _float Interpolation::IntegralElasticInOut() { return 0.5f; }

inline _float Interpolation::IntegralElasticOutIn() { return 0.5f; }

inline _float Interpolation::IntegralBackInOut() { return 0.5f; }

inline _float Interpolation::IntegralBackOutIn() { return 0.5f; }

inline _float Interpolation::IntegralBounceInOut() { return 0.5f; }

inline _float Interpolation::IntegralBounceOutIn() { return 0.5f; }
