...
public:
	...
	inline Matrix3x4( _float m00, _float m01, _float m02, _float m10, _float m11, _float m12, _float m20, _float m21, _float m22, _float m30, _float m31, _float m32 );
	//! Constructor, create a matrix and sets components.
...
Matrix3x4::Matrix3x4( _float m00, _float m01, _float m02, _float m10, _float m11, _float m12, _float m20, _float m21, _float m22, _float m30, _float m31, _float m32 )
{
...
{
	m[0][0] = rotation.m[0][0]; m[0][1] = rotation.m[1][0]; m[0][2] = rotation.m[2][0];
	m[1][0] = rotation.m[0][1]; m[1][1] = rotation.m[1][1]; m[1][2] = rotation.m[2][1];
	m[2][0] = rotation.m[0][2]; m[2][1] = rotation.m[1][2]; m[2][2] = rotation.m[2][2];
...
{
	return Matrix3x4( m[0][0], m[0][1], m[0][2], m[1][0], m[1][1], m[1][2], m[2][0], m[2][1], m[2][2], m[3][0], m[3][1], m[3][2] );
}
