...
const Vector3& Matrix4Adjustor::GetTranslation() const { return mTranslation; }

const Vector3& Matrix4Adjustor::GetScaling() const { return mScaling; }

const Vector3& Matrix4Adjustor::GetRotation() const { return mRotation; }

_float Matrix4Adjustor::GetHeight() const { return mHeight; }
