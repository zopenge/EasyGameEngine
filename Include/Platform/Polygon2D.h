...
class Polygon2D {
 ...
 private:
  ...
  _ubool IsTriangleValid(_dword v1_index, _dword v2_index,
                         _dword v3_index) const;
 ...
 public:
  ...
  _ubool DividePolygon(const Array<Vector2>& divide_line, Polygon2D& polygon1,
                       Polygon2D& polygon2);
  _void FixPolygon();
 ...
 public:
  static _ubool GetCircleProgressPolygon(const Vector2& pos,
                                         const Vector2& size,
                                         const FloatRange& angle_range,
                                         Polygon2D& polygon);
  static _ubool GetCircleProgressPolygon(const Vector2& pos,
                                         const Vector2& size,
                                         const FloatRange& angle_range,
                                         Array<Triangle2D>& triangles);
};
