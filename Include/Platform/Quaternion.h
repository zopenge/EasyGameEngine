...
class Quaternion {
 ...
 public:
  ...
  //! Subtract a quaternion from current quaternion, return a new quaternion to
  //! save result.
  //! @param quaternion	The quaternion to subtract.
  //! @return The result quaternion of subtraction.
  inline Quaternion operator-(const Quaternion& quaternion) const;
  //! Multiply a quaternion to current quaternion, return a new quaternion to
  //! save result.( do not use the standard quaternion multiplication )
  //! @param quaternion	The quaternion to multiply.
  //! @return The result quaternion of multiplication.
  Quaternion operator*(const Quaternion& quaternion) const;
  //! Divide a quaternion to current quaternion, return a new quaternion to save
  //! result.
  //! @param quaternion	The quaternion to divide.
  //! @return The result quaternion of division.
  Quaternion operator/(const Quaternion& quaternion) const;
  ...
  _ubool Equal(const Quaternion& quaternion,
  ...
  //! @param src_coordinate_axis1	The one axis of source coordinate system
  //! to be rotated.
  //! @param src_coordinate_axis2	The another axis of source coordinate
  //! system to be rotated.
  //! @param des_coordinate_axis1	The one axis of the target coordinate
  //! system to rotate into.
  //! @param des_coordinate_axis2	The another axis of the target
  //! coordinate system to rotate into.
  //! @return The rotation quaternion.
  Quaternion& Rotation(const Vector3& src_coordinate_axis1,
  ...
  //! function.
  //! @param radian		The angle of rotation in radian, get from this
  //! function.
  ...
  static _float Dot(const Quaternion& quaternion1,
  ...
  //! @param quaternion1	Source quaternion 1.
  //! @param quaternion2	Source quaternion 2.
  //! @param dont		Parameter for slerp, get from this
  //! function.
  //! @param theta		Parameter for slerp, get from this
  //! function.
  ...
  //! @return The result quaternion of interpolation.
  static Quaternion Slerp(const Quaternion& quaternion1,
                          const Quaternion& quaternion2, _float dot,
                          _float theta, _float recipsqrt, _float factor);
};
