...
public:
	...
	//! @return		The pick ray.
	static Ray GetPickRay( _int x, _int y, const PointU& viewport_size, const Matrix4& view_transform, const Matrix4& projection_transform );
	static Ray GetPickRay( _float x, _float y, _float sizex, _float sizey, const Matrix4& view_transform, const Matrix4& projection_transform );
};
