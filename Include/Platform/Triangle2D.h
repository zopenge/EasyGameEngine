...
public:
	inline Triangle2D( );
	inline Triangle2D( const Vector2& vector1, const Vector2& vector2, const Vector2& vector3 );
...
Triangle2D::Triangle2D( const Vector2& vector1, const Vector2& vector2, const Vector2& vector3 )
