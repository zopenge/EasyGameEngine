...
public:
	...
	//! @export_script_method("Calculates the square of vector magnitude, this function is faster than Magnitude")
	//! @param		none
...
inline _float Vector2::Magnitude( ) const
{
	return Math::Sqrt( x * x + y * y );
}

inline _float Vector2::MagnitudeSquared( ) const
{
	return x * x + y * y;
}
...
{
#if (_USE_NEON_ == 1)
	return dot2_neon( (float*)&vector1, (float*)&vector2 );
#else
