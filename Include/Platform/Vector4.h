...
inline _ubool Vector4::Equal(const Vector4& vector, _float margin) const {
  ...
  if (Math::Abs(w - vector.w) > margin) return _false;
...
inline _float Vector4::MagnitudeSquared() const { return Dot(*this, *this); }
...
inline Vector4 Vector4::Project(const Vector4& vector1,
...
inline Vector4 Vector4::Lerp(const Vector4& vector1, const Vector4& vector2,
                             _float factor) {
