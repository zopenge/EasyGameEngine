...
Version::Version( _word major, _word minor, _word modified, _word buildnumber ) : mMajor( major ), mMinor( minor ), mModified( modified ), mBuildNumber( buildnumber )
{
...
Version::Version( AStringPtr versionstring )
{
	...
	Platform::AnsiToUtf16( versionstring_unicode, 1024, versionstring.Str( ) );
...
Version::Version( UStringPtr versionstring )
{
	// Convert string to UNICODE
	_charw versionstring_unicode[1024];
	Platform::Utf8ToUtf16( versionstring_unicode, 1024, versionstring.Str( ) );
...
Version::Version( WStringPtr versionstring )
{
	...
	SafeCopyString( string_buffer, versionstring.Str( ) );
...
AString Version::ToAString( _dword tags_number ) const
{
	...
	_chara buffer[1024]; buffer[0] = 0;

	switch ( tags_number )
	{
		case 1: Platform::FormatStringBuffer( buffer, EGE_ARRAY_NUMBER( buffer ), "%d", mMajor ); break;
		case 2: Platform::FormatStringBuffer( buffer, EGE_ARRAY_NUMBER( buffer ), "%d.%d", mMajor, mMinor ); break;
		case 3: Platform::FormatStringBuffer( buffer, EGE_ARRAY_NUMBER( buffer ), "%d.%d.%d", mMajor, mMinor, mModified ); break;
		case 4: Platform::FormatStringBuffer( buffer, EGE_ARRAY_NUMBER( buffer ), "%d.%d.%d.%d", mMajor, mMinor, mModified, mBuildNumber ); break;
		default:
			break;
	}
