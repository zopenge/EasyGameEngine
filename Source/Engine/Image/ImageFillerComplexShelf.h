//! @file     ImageFillerComplexShelf.h
//! @author   LiCode
//! @version  1.0
//! @date     2007.10
//! Copyright ...
...
//----------------------------------------------------------------------------
// ImageFillerComplexShelf
//----------------------------------------------------------------------------

class ImageFillerComplexShelf : public INTERFACE_IMAGE_FILLER_IMPL( IImageFiller )
{
private:
...
public:
	ImageFillerComplexShelf( const PointU& size, const PointU& space );
	virtual ~ImageFillerComplexShelf( );
