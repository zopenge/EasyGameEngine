//! @file     androidAnalyticsCenter.Flurry.h
//! @author   LiCode
//! @version  1.1.0.621
//! @date     2011/01/17
...
//----------------------------------------------------------------------------
// androidAnalyticsCenterFlurry
//----------------------------------------------------------------------------

class androidAnalyticsCenterFlurry: public TObject< IAnalyticsCenter >
{
private:
	//!	The analySDK interface object
	JNIObject	mAnalyticesCenterJNIObject;

public:
	androidAnalyticsCenterFlurry( );
	virtual ~androidAnalyticsCenterFlurry( );
