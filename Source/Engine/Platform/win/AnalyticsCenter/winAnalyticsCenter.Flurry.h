//! @file     winAnalyticsCenter.Flurry.h
//! @author   LiCode
//! @version  1.1.0.621
//! @date     2011/01/17
...
//----------------------------------------------------------------------------
// winAnalyticsCenterFlurry
//----------------------------------------------------------------------------

class winAnalyticsCenterFlurry : public TObject< IAnalyticsCenter >
{
private:

public:
	winAnalyticsCenterFlurry( );
	virtual ~winAnalyticsCenterFlurry( );
