...
public:
	...
	virtual _ubool	AddTransaction( ITransaction* transaction, ITransaction* depend, _dword features, _dword timeout = -1, const QwordParams2& params = QwordParams2::cNull ) override;
};
