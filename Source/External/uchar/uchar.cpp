...
STATIC_ASSERT(sizeof(uchar) == sizeof(unsigned short), "Check the uchar size");
STATIC_ASSERT(sizeof(uchar16) == sizeof(unsigned short),
              "Check the uchar16 size");
...
int uc_toi(const uchar *str) { return (int)uc_tol(str, NULL, 10); }
