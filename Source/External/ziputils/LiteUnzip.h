...
typedef struct
{
	...
	DWORD			CurrEntryPosInCentralDir;
#ifdef WIN32
...
DWORD WINAPI UnzipGetFirstItemW(HUNZIP, ZIPENTRY *);
DWORD WINAPI UnzipGetNextItemW(HUNZIP, ZIPENTRY *);
DWORD WINAPI UnzipSetCurItemW(HUNZIP, ZIPENTRY *);
