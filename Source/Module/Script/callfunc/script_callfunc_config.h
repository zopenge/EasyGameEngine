//! @file     script_callfunc_config.h
//!	@brief	  Copy from AngelScript project, Thanks for good job.
//! @author   LiCode
//! @version  1.1
//! @date     2007.10
//! Copyright ...
...
// Embarcadero C++Builder
  ...
  #error "Configuration doesn't yet support BCC for AMD64."
	...
	#define MULTI_BASE_OFFSET(x) (*((_dword*)(&x)+1))
	#define HAVE_VIRTUAL_BASE_OFFSET
	#define VIRTUAL_BASE_OFFSET(x) (*((_dword*)(&x)+2))
...
// Microsoft Visual C++
	...
	#ifdef _M_X64
		#define MULTI_BASE_OFFSET(x) (*((_dword*)(&x)+2))
		#define VIRTUAL_BASE_OFFSET(x) (*((_dword*)(&x)+4))
	#else
		#define MULTI_BASE_OFFSET(x) (*((_dword*)(&x)+1))
		#define VIRTUAL_BASE_OFFSET(x) (*((_dword*)(&x)+3))
	#endif
	#define HAVE_VIRTUAL_BASE_OFFSET
	#define THISCALL_RETURN_SIMPLE_IN_MEMORY
...
// GNU C (and MinGW or Cygwin on Windows)
	...
	#define MULTI_BASE_OFFSET(x) (*((_dword*)(&x)+1))
#else
	#define MULTI_BASE_OFFSET(x) (*((_qword*)(&x)+1))
#endif
	#define asVSNPRINTF(a, b, c, d) vsnprintf(a, b, c, d)
	#define CALLEE_POPS_HIDDEN_RETURN_POINTER
	#define COMPLEX_OBJS_PASSED_BY_REF
...
#define	ARG_W(b)    ((_word*)&b)
#define	ARG_DW(b)   ((_dword*)&b)
#define	ARG_QW(b)   ((_qword*)&b)
#define	BCARG_W(b)  ((_word*)&(b)[1])
#define	BCARG_DW(b) ((_dword*)&(b)[1])
#define	BCARG_QW(b) ((_qword*)&(b)[1])

#ifdef AS_64BIT_PTR
	#define AS_PTR_SIZE  2
	#define asPTRWORD    _qword
	#define asBC_RDSPTR  asBC_RDS8
#else
	#define AS_PTR_SIZE  1
	#define asPTRWORD    _dword
