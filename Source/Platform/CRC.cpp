...
_crcvalue CRC::BuildFromBuffer( const _byte* buffer, _dword size, _crcvalue oldcrc )
{
	if ( buffer == _null || size == 0 )
		return 0;

	_crcvalue crc = ~oldcrc;
...
_crcvalue CRC::BuildFromString( const _chara* string, _dword flag, _crcvalue oldcrc )
{
	if ( string == _null )
		return 0;
...
_crcvalue CRC::BuildFromString( const _charw* string, _dword flag, _crcvalue oldcrc )
{
	if ( string == _null )
		return 0;
