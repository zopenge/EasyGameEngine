...
IPAddress IPAddress::cNull;

IPAddress& IPAddress::FromString(WStringPtr address) {
...
AString IPAddress::ToStringA(_ubool with_port) const {
...
WString IPAddress::ToStringW(_ubool with_port) const {
