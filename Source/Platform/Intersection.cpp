...
PolygonCollisionResult Intersection::Polygon2DVSPolygon2D( const Vector2 polygon1 [], _dword length1, const Vector2 polygon2 [], _dword length2, const Vector2& velocity )
{
	...
	for ( _dword i = 0; i < length1 + length2; ++ i )
	{
		...
		_float minA = 0; _float minB = 0; _float maxA = 0; _float maxB = 0;
...
_ubool Intersection::RayVSAABox( const Ray& ray, const AxisAlignedBox& box, _float* distance )
{
	if ( distance != _null )
...
_ubool Intersection::AABoxVSAABox( const AxisAlignedBox& box1, const AxisAlignedBox& box2 )
{
...
_ubool Intersection::AABoxVSPlane( const AxisAlignedBox& box, const Plane& plane )
{
...
_ubool Intersection::AABoxVSSphere( const AxisAlignedBox& box, const Sphere& sphere )
{
