...
Matrix3x4& Matrix3x4::operator = ( const Matrix4& matrix )
{
	...
	m[3][0] = matrix.m[0][3]; m[3][1] = matrix.m[1][3]; m[3][2] = matrix.m[2][3];
...
Matrix3x4& Matrix3x4::operator += ( const Matrix3x4& matrix )
{
	...
	m[3][0] += matrix.m[3][0]; m[3][1] += matrix.m[3][1]; m[3][2] += matrix.m[3][2];
...
Matrix3x4& Matrix3x4::RotationX( _float radian )
{
	...
	m[1][0] = 0.0f; m[1][1] =   sincos_value[1];	m[1][2] = sincos_value[0];
	m[2][0] = 0.0f; m[2][1] = - sincos_value[0];	m[2][2] = sincos_value[1];
...
Matrix3x4& Matrix3x4::RotationY( _float radian )
{
	...
	m[0][0]	= sincos_value[1];	m[0][1] = 0.0f; m[0][2] = - sincos_value[0];
	m[1][0] = 0.0f;				m[1][1] = 1.0f; m[1][2] =   0.0f;
	m[2][0] = sincos_value[0];	m[2][1] = 0.0f; m[2][2] =   sincos_value[1];
...
Matrix3x4& Matrix3x4::RotationZ( _float radian )
{
	...
	m[0][0]	=   sincos_value[1];	m[0][1] = sincos_value[0];	m[0][2] = 0.0f;
	m[1][0] = - sincos_value[0];	m[1][1] = sincos_value[1];	m[1][2] = 0.0f;
...
{
	m[0][0] = rotation.m[0][0]; m[0][1] = rotation.m[0][1]; m[0][2] = rotation.m[0][2];
	m[1][0] = rotation.m[1][0]; m[1][1] = rotation.m[1][1]; m[1][2] = rotation.m[1][2];
	m[2][0] = rotation.m[2][0]; m[2][1] = rotation.m[2][1]; m[2][2] = rotation.m[2][2];
