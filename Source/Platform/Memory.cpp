...
_dword Memory::GetCurAllocNumber() const { return mCurAllocNumber; }

_void Memory::ClearCurAllocNumber() { mCurAllocNumber = 0; }

_dword Memory::GetCurAllocSize() const { return mCurAllocSize; }
