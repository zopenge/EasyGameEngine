...
_chara* anyPlatformConverter::ConvertLongToString(_int value, _dword radix,
                                                  _chara* string,
                                                  _dword length) {
  if (string == _null || length == 0) return _null;
...
_chara* anyPlatformConverter::ConvertDwordToString(_dword value, _dword radix,
                                                   _chara* string,
                                                   _dword length) {
  if (string == _null || length == 0) return _null;
...
_chara* anyPlatformConverter::ConvertLargeToString(_large value, _dword radix,
                                                   _chara* string,
                                                   _dword length) {
  if (string == _null || length == 0) return _null;
...
_chara* anyPlatformConverter::ConvertQwordToString(_qword value, _dword radix,
                                                   _chara* string,
                                                   _dword length) {
  if (string == _null || length == 0) return _null;
...
_chara* anyPlatformConverter::ConvertFloatToString(_float value, _chara* string,
                                                   _dword length,
                                                   _dword precision) {
  return ConvertDoubleToString((_double)value, string, length, precision);
}

_chara* anyPlatformConverter::ConvertDoubleToString(_double value,
                                                    _chara* string,
                                                    _dword length,
                                                    _dword precision) {
  if (string == _null || length == 0) return _null;
  ...
  if (decpt < 0) {
    *des_string++ = '.';
    ...
    for (_int i = decpt; i < 0; i++) *des_string++ = '0';
  } else {
...
_charw* anyPlatformConverter::ConvertLongToString(_int value, _dword radix,
                                                  _charw* string,
                                                  _dword length) {
  if (string == _null || length == 0) return _null;
...
_charw* anyPlatformConverter::ConvertDwordToString(_dword value, _dword radix,
                                                   _charw* string,
                                                   _dword length) {
  if (string == _null || length == 0) return _null;
...
_charw* anyPlatformConverter::ConvertLargeToString(_large value, _dword radix,
                                                   _charw* string,
                                                   _dword length) {
  if (string == _null || length == 0) return _null;
...
_charw* anyPlatformConverter::ConvertQwordToString(_qword value, _dword radix,
                                                   _charw* string,
                                                   _dword length) {
  if (string == _null || length == 0) return _null;
...
_charw* anyPlatformConverter::ConvertFloatToString(_float value, _charw* string,
                                                   _dword length,
                                                   _dword precision) {
...
_charw* anyPlatformConverter::ConvertDoubleToString(_double value,
                                                    _charw* string,
                                                    _dword length,
                                                    _dword precision) {
  _chara ansi_string_buffer[1024];
...
_boolean anyPlatformConverter::ConvertStringToBool(const _chara* string) {
  if (string == _null) return _false;

  if (Platform::CompareString(string, "false", _true) == 0 ||
      Platform::CompareString(string, "0") == 0)
    return _false;

  return _true;
}

_int anyPlatformConverter::ConvertStringToLong(const _chara* string,
                                               _dword radix) {
  if (string == _null) return 0;

  _chara* endpointer = _null;
  return strtol(string, &endpointer, radix);
}

_dword anyPlatformConverter::ConvertStringToDword(const _chara* string,
                                                  _dword radix) {
  if (string == _null) return 0;
...
_large anyPlatformConverter::ConvertStringToLarge(const _chara* string,
                                                  _dword radix) {
  if (string == _null) return 0;
...
_qword anyPlatformConverter::ConvertStringToQword(const _chara* string,
                                                  _dword radix) {
  if (string == _null) return 0;
...
_boolean anyPlatformConverter::ConvertStringToBool(const _charw* string) {
  ...
  if (Platform::CompareString(string, L"false", _true) == 0 ||
      Platform::CompareString(string, L"0") == 0)
    return _false;

  return _true;
}

_int anyPlatformConverter::ConvertStringToLong(const _charw* string,
                                               _dword radix) {
  if (string == _null) return 0;
...
_dword anyPlatformConverter::ConvertStringToDword(const _charw* string,
                                                  _dword radix) {
  if (string == _null) return 0;
...
_large anyPlatformConverter::ConvertStringToLarge(const _charw* string,
                                                  _dword radix) {
  if (string == _null) return 0;
...
_qword anyPlatformConverter::ConvertStringToQword(const _charw* string,
                                                  _dword radix) {
