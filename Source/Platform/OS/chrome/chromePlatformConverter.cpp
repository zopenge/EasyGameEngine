//! @file     chromePlatformConverter.cpp
//! @author   LiCode
//! @version  1.1
//! @date     2007.10
//! Copyright ...
...
_chara* Platform::ConvertLongToString( _long value, _dword radix, _chara* string, _dword length )
{
...
_charw* Platform::ConvertLongToString( _long value, _dword radix, _charw* string, _dword length )
{
	return anyPlatformConverter::ConvertLongToString( value, radix, string, length );
}
...
_long Platform::ConvertStringToLong( const _chara* string, _dword radix )
{
...
_long Platform::ConvertStringToLong( const _charw* string, _dword radix )
{
	return anyPlatformConverter::ConvertStringToLong( string, radix );
}
