...
{
	// http://stackoverflow.com/questions/12839196/detect-cpu-cores-on-ios-device
	unsigned int ncpu = 0; size_t len = sizeof( ncpu );
	sysctlbyname( "hw.ncpu", &ncpu, &len, _null, 0 );
