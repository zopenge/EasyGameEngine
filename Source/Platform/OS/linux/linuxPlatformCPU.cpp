		...
		if (android_cpu_features & 1) {
			switch (cpu_family) {
				...
				case _CPU_FAMILY_X86: {
					switch (1 << i) {
						case ANDROID_CPU_X86_FEATURE_SSSE3:
							cpu_features |= _CPU_FEATURE_SSSE3;
							break;
						case ANDROID_CPU_X86_FEATURE_POPCNT:
							cpu_features |= _CPU_FEATURE_POPCNT;
							break;
						case ANDROID_CPU_X86_FEATURE_MOVBE:
							cpu_features |= _CPU_FEATURE_MOVBE;
							break;
						default:
							break;
					}
				...
				case _CPU_FAMILY_ARM: {
					switch (1 << i) {
						case ANDROID_CPU_ARM_FEATURE_ARMv7:
							cpu_features |= _CPU_FEATURE_ARMv7;
							break;
						case ANDROID_CPU_ARM_FEATURE_VFPv3:
							cpu_features |= _CPU_FEATURE_VFPv3;
							break;
						case ANDROID_CPU_ARM_FEATURE_NEON:
							cpu_features |= _CPU_FEATURE_NEON;
							break;
						case ANDROID_CPU_ARM_FEATURE_LDREX_STREX:
							cpu_features |= _CPU_FEATURE_LDREX_STREX;
							break;
						default:
							break;
					}
