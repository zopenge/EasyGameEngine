...
_handle anyPlatformProcess::CreateNamedPipe(
    const _charw* name, _PIPE_ACCESS accessmode, _dword mode, _dword maxnumber,
    _dword outbuffersize, _dword inbuffersize, _dword timeout) {
  return _null;
}

_ubool anyPlatformProcess::ConnectNamedPipe(_handle handle) { return _true; }
...
_ubool anyPlatformProcess::PeekNamedPipe(_handle handle, _void* buffer,
                                         _dword size, _dword* bytesread,
                                         _dword* total_bytes_avail,
                                         _dword* bytes_left) {
  return _true;
}

_ubool anyPlatformProcess::GetModuleFileName(_handle module, _charw* name,
                                             _dword length) {
  return _false;
}
...
_ubool anyPlatformProcess::SetProcessAffinityMask(_handle processhandle,
                                                  _dword mask) {
  return _false;
}

_ubool anyPlatformProcess::SetThreadAffinityMask(_handle threadhandle,
                                                 _dword mask,
                                                 _dword* prevmask) {
  return _false;
}

_ubool anyPlatformProcess::GetProcessAffinityMask(_handle processhandle,
                                                  _dword& mask,
                                                  _dword* systemmask) {
  return _false;
}

_dword anyPlatformProcess::GetProcessID(_handle processhandle) { return 0; }

_handle anyPlatformProcess::GetProcessHandle(_dword processid) { return _null; }

_thread_id anyPlatformProcess::GetMainThreadID() { return gMainThreadID; }
...
_dword anyPlatformProcess::GetCurrentProcessID() { return 0; }
...
_handle anyPlatformProcess::GetCurrentProcessHandle() { return _null; }

_handle anyPlatformProcess::GetCurrentThreadHandle() { return _null; }

_ubool anyPlatformProcess::SetThreadName(_thread_id threadid,
                                         const _chara* name) {
...
_ubool anyPlatformProcess::SetThreadPriority(_handle thread,
                                             _PRIORITY priority) {
  return _false;
}

_ubool anyPlatformProcess::SuspendThread(_handle thread) { return _false; }

_ubool anyPlatformProcess::ResumeThread(_handle thread) { return _false; }

_ubool anyPlatformProcess::GetThreadTimes(_handle thread, _qword* creationtime,
                                          _qword* exittime, _qword* kerneltime,
                                          _qword* usertime) {
  return _false;
}

_float anyPlatformProcess::GetThreadCPUUsage(_handle thread, _dword timenow,
                                             _qword& last_thread_time,
                                             _qword& last_sample_time,
                                             _qword& last_sample_delta) {
  return 0.0f;
}

_ubool anyPlatformProcess::QueueUserAPC(_handle thread,
                                        Platform::OnAPCProc funcpointer,
                                        _void* parameter) {
  return _false;
}
...
_ubool anyPlatformProcess::GetExitCodeThread(_handle thread,
                                             _dword& exit_code) {
  return _false;
}
...
_ubool anyPlatformProcess::FreeLibrary(_handle module) { return _false; }

_void anyPlatformProcess::ExitProcess(_dword exitcode) {}

_ubool anyPlatformProcess::TerminateProcess(_handle processhandle,
                                            _dword exitcode) {
  return _false;
}
...
_ubool anyPlatformProcess::CreateProcess(
    const _chara* modulename, const _chara* cmdline, _dword creationflags,
    const _chara* workdir, _handle* processhandle, _handle* threadhandle) {
  return _false;
}

_ubool anyPlatformProcess::CreateProcess(
    const _charw* modulename, const _charw* cmdline, _dword creationflags,
    const _charw* workdir, _handle* processhandle, _handle* threadhandle) {
  return _false;
}

_ubool anyPlatformProcess::ReadProcessMemory(_handle processhandle,
                                             const _void* baseaddress,
                                             _void* buffer, _dword size,
                                             _dword* bytesread) {
  return _false;
}