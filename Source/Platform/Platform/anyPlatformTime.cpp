...
_ubool anyPlatformTime::GetLocalTime( CalendarTime& calendar_time )
{
	...
	if ( anyPlatformTime::GetLocalTime( time_interval.tv_sec, calendar_time ) == _false )
		return _false;
...
_ubool anyPlatformTime::GetLocalTime( _time_t raw_time, CalendarTime& calendar_time )
{
	// Get the local time
	tm time_info;
...
_time_t anyPlatformTime::GetLocalTime( )
{
	return time( _null );
}
...
_ubool anyPlatformTime::GetGMTTime( CalendarTime& calendar_time )
{
	...
	if ( anyPlatformTime::GetGMTTime( time_interval.tv_sec, calendar_time ) == _false )
		return _false;
...
_ubool anyPlatformTime::GetGMTTime( _time_t raw_time, CalendarTime& calendar_time )
{
...
_ubool anyPlatformTime::SystemTimeToFileTime( FileTime& filetime, const CalendarTime& systemtime )
{
...
_ubool anyPlatformTime::FileTimeToSystemTime( CalendarTime& systemtime, const FileTime& filetime )
{
...
_ubool anyPlatformTime::FileTimeToLocalFileTime( FileTime& localfiletime, const FileTime& filetime )
{
...
_ubool anyPlatformTime::LocalFileTimeToFileTime( FileTime& filetime, const FileTime& localfiletime )
{
