...
_ubool Platform::GetPlatformVersion( _dword& major, _dword& minor )
{
	...
	major = work_station_info->wki100_ver_major;
	minor = work_station_info->wki100_ver_minor;
...
{
	return EGE_BOOLEAN( ::SetEvent( object ) );
}

_ubool Platform::ResetEvent( _handle object )
{
	return EGE_BOOLEAN( ::ResetEvent( object ) );
}
