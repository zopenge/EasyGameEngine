...
WStringPtr Variable::GetTypeIDString( _dword type )
{
 switch ( type )
 {
  case _TYPE_ID_INT8:  return L"_tiny";
  case _TYPE_ID_INT16: return L"_short";
  case _TYPE_ID_INT32: return L"_int";
  case _TYPE_ID_INT64: return L"_large";
  case _TYPE_ID_UINT8: return L"_byte";
  case _TYPE_ID_UINT16: return L"_word";
  case _TYPE_ID_UINT32: return L"_dword";
  case _TYPE_ID_UINT64: return L"_qword";
  case _TYPE_ID_FLOAT: return L"_float";
  case _TYPE_ID_DOUBLE: return L"_double";
  case _TYPE_ID_WSTRING: return L"String";
  case _TYPE_ID_POINTER: return L"_void*";
  default:
   return L"";
 }
}
...
_dword Variable::GetTypeIDSize( _dword type )
{
 switch ( type )
 {
  case _TYPE_ID_INT8:  return 1;
  case _TYPE_ID_INT16: return 2;
  case _TYPE_ID_INT32: return 4;
  case _TYPE_ID_INT64: return 8;
  case _TYPE_ID_UINT8: return 1;
  case _TYPE_ID_UINT16: return 2;
  case _TYPE_ID_UINT32: return 4;
  case _TYPE_ID_UINT64: return 8;
  case _TYPE_ID_FLOAT: return 4;
  case _TYPE_ID_DOUBLE: return 8;
  case _TYPE_ID_WSTRING: return 4;
  case _TYPE_ID_POINTER: return 4;
  default:
   return 0;
 }
}
